...
class MenuListRecyclcerViewAdapter (val ctx: Context, val menulist : ArrayList<MenuListData>) : RecyclerView.Adapter<MenuListRecyclcerViewAdapter.Holder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MenuListRecyclcerViewAdapter.Holder {
    ...
    override fun onBindViewHolder(holer: MenuListRecyclcerViewAdapter.Holder, position: Int) {
